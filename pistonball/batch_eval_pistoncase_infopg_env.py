...
class Piston5AgentCase(PistonEnv):
    ...
    def loop(self, user_params: Dict, policies: Dict[str, PistonPolicyCASE], optimizers: Dict[str, torch.optim.Optimizer], schedulers, render=False, rand_piston_2=True):
        """
        ...
        with torch.no_grad():
            for epoch in range(0, epochs):
                ...
                for step in range(self.MAX_CYCLES):
                    ...
                    for agent in self.AGENT_NAMES:
                        if rand_piston_2 and agent == 'piston_2':
...
if __name__ == '__main__':
    ...
    policies, optimizers, summary_stats = env.loop(user_params, policies, optimizers, None, render=render, rand_piston_2=rand_piston_2)
