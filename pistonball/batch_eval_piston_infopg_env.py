...
class Piston5AgentByz(PistonEnv):
    ...
    def loop(self, user_params: Dict, policies: Dict[str, PistonPolicy], optimizers: Dict[str, torch.optim.Optimizer], schedulers, render=False):
        """
...
if __name__ == '__main__':
    ...
    hyper_params = {
        ...
        'transfer_experiment': {
            ...
            'name': './experiments/case_test/2023-04-18 01_41_23infopg',
    ...
    policies, optimizers, summary_stats = env.loop(user_params, policies, optimizers, None, render=render)
